...
def parse_player_types():
    ...
    parser.add_argument("--player1", "--p1", dest="player1", default="human",
        choices=["human", "q-learning", "sarsa", "alpha-beta", "ai"],
        help="Player 1 type (human, q-learning, sarsa, alpha-beta, ai).")
    parser.add_argument("--player2", "--p2", dest="player2", default="q-learning",
        choices=["human", "q-learning", "sarsa", "alpha-beta", "ai"],
...
sarsa_player_one = SarsaAgent(epsilon=0.0, weights=list(DEFAULT_WEIGHTS))
sarsa_player_two = SarsaAgent(epsilon=0.0, weights=list(DEFAULT_WEIGHTS))
q_player_one = QLearning(epsilon=0.0, weights=list(DEFAULT_WEIGHTS))
q_player_two = QLearning(epsilon=0.0, weights=list(DEFAULT_WEIGHTS))
...
def runGame():
    ...
    while True:
        while theWinner == 0:
            ...
            # Place stone first, then check win (already correct order)
